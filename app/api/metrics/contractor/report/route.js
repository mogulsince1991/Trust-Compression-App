      ...
      },
      {
        ...
        rows: limitDebugRows(
          liveJobs.map((row) => ({
            ...
            jobSoldDate: row.jobSoldDate ?? null,
            ...
            approvedOrderRevenueMax: row.approvedOrderRevenueMax ?? 0,
            approvedOrderRevenueSum: row.approvedOrderRevenueSum ?? 0,
            projectedRevenue: row.projectedRevenue ?? 0,
            projectedRevenueWithTax: row.projectedRevenueWithTax ?? 0,
            customFieldRevenue: row.customFieldRevenue ?? 0,
            accountFieldRevenue: row.accountFieldRevenue ?? 0,
            resolvedRevenueField: row.resolvedRevenueField ?? null,
            customApprovedOrdersKey: row.customApprovedOrdersKey ?? null,
            accountApprovedOrdersKey: row.accountApprovedOrdersKey ?? null,
            customApprovedOrdersCandidates: row.customApprovedOrdersCandidates ?? null,
            accountApprovedOrdersCandidates: row.accountApprovedOrdersCandidates ?? null,
            approvedOrderDocumentCount: row.approvedOrderDocumentCount ?? 0,
            approvedOrderAmounts: row.approvedOrderAmounts ?? null,
            source: row.source ?? null,
            campaign: row.campaign ?? null,
        ...
        columns: [
          ...
          { key: "jobSoldDate", label: "Job Sold Date" },
          { key: "approvedOrderSoldDate", label: "Approved Order Date" },
          { key: "soldDateSource", label: "Sold Date Source" },
          { key: "appointmentDate", label: "Appointment / Created" },
          { key: "status", label: "Status" },
          { key: "revenue", label: "Revenue", format: "currency" },
          { key: "approvedOrderRevenueMax", label: "Approved Order Max", format: "currency" },
          { key: "approvedOrderRevenueSum", label: "Approved Order Sum", format: "currency" },
          { key: "projectedRevenue", label: "Projected", format: "currency" },
          { key: "projectedRevenueWithTax", label: "Projected w/ Tax", format: "currency" },
          { key: "resolvedRevenueField", label: "Resolved Revenue Field" },
          { key: "customFieldRevenue", label: "Custom Field Revenue", format: "currency" },
          { key: "customApprovedOrdersKey", label: "Custom Approved Key" },
          { key: "customApprovedOrdersCandidates", label: "Custom Approved Candidates" },
          { key: "accountFieldRevenue", label: "Account Field Revenue", format: "currency" },
          { key: "accountApprovedOrdersKey", label: "Account Approved Key" },
          { key: "accountApprovedOrdersCandidates", label: "Account Approved Candidates" },
          { key: "approvedOrderDocumentCount", label: "Approved Docs" },
          { key: "approvedOrderAmounts", label: "Approved Order Amounts" },
          { key: "source", label: "Source" },
          { key: "campaign", label: "Campaign" },
...
function toConfiguredJobRow(row) {
  return {
    ...
    job_sold_date: row.jobSoldDate ?? null,
    approved_order_sold_date: row.approvedOrderSoldDate ?? null,
    sold_date_source: row.soldDateSource ?? null,
    status: row.status ?? null,
    project_type: row.projectType ?? null,
    revenue: row.revenue ?? 0,
    net_sales: row.netSales ?? row.revenue ?? 0,
    custom_fields: row.customFields ?? null,
    account_fields: row.accountFields ?? null,
    custom_field_revenue: row.customFieldRevenue ?? 0,
    account_field_revenue: row.accountFieldRevenue ?? 0,
    resolved_revenue_field: row.resolvedRevenueField ?? null,
