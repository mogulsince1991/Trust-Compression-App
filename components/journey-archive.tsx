...
export function JourneyArchive({ activeWorkspaceId, onChanged }: { activeWorkspaceId: string; onChanged?: () => void }) {
    ...
    return (
      <main className="archive-page">
        <section className="archive-empty">
          ...
          <Link className="archive-primary" href="/app/journeys">
            Back to sign in
          </Link>
        </section>
      </main>
  ...
  return (
    <main className="archive-page">
      <header className="archive-header">
        <div>
          <Link className="archive-back" href="/app/journeys">
