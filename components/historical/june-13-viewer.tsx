...
export function JourneyViewer({ journey, frameWindow }: { journey: PublicJourney; frameWindow: Window }) {
...
// Historical comparison must not write old analytics or browser identifiers.
function getViewerId() { return "historical-comparison"; }
async function trackJourneyEvent(_payload: unknown) {}
